...
class Model(nn.Module):
    def __init__(self, num_classes,num_frames, num_heads=3, num_channels=3, kernel_size=[3, 5],
                 use_pes=True, config=None,att_drop=0, dropout=0, dropout2d=0, len_parts=6, num_joints=25):
        super().__init__()
